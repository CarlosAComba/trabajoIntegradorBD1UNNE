...
IF OBJECT_ID('auditoriaConsorcio', 'U') IS NOT NULL
    DROP TABLE auditoriaConsorcio;
GO
...
IF OBJECT_ID('trg_auditConsorcio_update', 'TR') IS NOT NULL
    DROP TRIGGER trg_auditConsorcio_update;
GO
...
IF OBJECT_ID('trg_auditConsorcio_delete', 'TR') IS NOT NULL
    DROP TRIGGER trg_auditConsorcio_delete;
GO
...
IF OBJECT_ID('auditoriaGasto', 'U') IS NOT NULL
    DROP TABLE auditoriaGasto;
GO
...
IF OBJECT_ID('trg_auditGasto_update', 'TR') IS NOT NULL
    DROP TRIGGER trg_auditGasto_update;
GO
...
IF OBJECT_ID('trg_auditAdmin_update', 'TR') IS NOT NULL
    DROP TRIGGER trg_auditAdmin_update;
GO
...
IF OBJECT_ID('trg_auditAdmin_delete', 'TR') IS NOT NULL
    DROP TRIGGER trg_auditAdmin_delete;
GO
